...
var ScreenNormal={
	...
	FONT_SIZE_SPLASH: 75,
	//splash
	SPLASH: {TEXT_PLAY_OFFSET_X: 65 + MOBILE_X_OFFSET, TEXT_PLAY_OFFSET_Y: 100, CURRENCY_ICON_OFFSET_X: 20 + MOBILE_X_OFFSET, CURRENCY_ICON_OFFSET_Y: 150, BUTTON_OFFSET_X: 60, BUTTON_OFFSET_Y: 140},
	//tutorial
...
var ScreenPixelRatio2={
	...
	//splash
	SPLASH: {TEXT_PLAY_OFFSET_X: 130 + MOBILE_X_OFFSET, TEXT_PLAY_OFFSET_Y: 200, CURRENCY_ICON_OFFSET_X: 40 + MOBILE_X_OFFSET, CURRENCY_ICON_OFFSET_Y: 300, BUTTON_OFFSET_X: 120, BUTTON_OFFSET_Y: 280},
	//tutorial
    ...
    //DJ_Table
    DJ_TABLE: {BACKGROUND: {POSX: 0, POSY: 1150},BUTTON: {POSX: [80,230,375], POSY: [1060, 1060, 1063], TOUCH_OFFSET: 250}, DISK_POS: {POSX: 700, POSY: 1210}, COMBO: {POSX: -50, POSY: 100}, SCORE: {POSX: -50, POSY: 160}, TIME:{POSX: 520, POSY_SEC: 160, POSY_MILISEC: 110}},
    //music note
    MUSIC_NOTE: {POSX: [225, 290, 350, 480], POSY: -150, POSY_15NOTE: 0, POSX_OFFSET: [-7, -3, 1, 8], NOTE_DISTANCE: 38, NOTE_OFFSET_Y: 95, BUTTON_EFFECT: {FRAME_WIDTH: 80,FRAME_HEIGHT: 87, POSX_OFFSET: -140, POSY_OFFSET: -290}},
    //music note for optimized
    ...
    //state loading
    LOADING: {BACKGROUND: {POSY: 1000, LOGOY: 150}, POSX: 375, OFFSET_Y: 170, BG_OFFSET_Y: -250, TEXT_OFFSET_Y: -100, BAR: {MAX_NOTE: 30, NOTE_WIDTH: 15, HEIGHT: 35, OFFSET: 4}},
    //state end game
    END_GAME: {DIALOG_POS_Y: 500, RETRY_BUTTON_OFFSET_X: 140, RETRY_BUTTON_OFFSET_Y: -150, GETIT_BUTTON_OFFSET_X: -280, GETIT_BUTTON_OFFSET_Y: -150, YOUR_SCORE_Y: 400, SCORE_Y: 170, FREE_CASH_OFFSET_Y: 55, FREE_CASH_ICON_OFFSET_Y: -5, DISCOUNT_X: 50, DISCOUNT_Y: 625, DISCOUNT_OFFSET_Y: 35, BG_OFFSET_Y: 20, BG_TEXT_OFFSET_Y: -285, PROMOBANNER_OFFSET_X: -94, PROMOBANNER_OFFSET_Y: -70},
    //effect
    EFFECT: {LIGHT_WIDTH: 95},
};
